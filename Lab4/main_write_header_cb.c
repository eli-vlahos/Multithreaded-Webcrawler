...
/* fetch function that returns image information */
struct recv_buf2 fetch( int image_option, int server ) 
{
    // initializes various arguments
    ...
    // initializes buf for information
